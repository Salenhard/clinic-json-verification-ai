...
6. НЕ добавляй поле если оно семантически не применимо к записи (например fracture_class не применимо к записям о вывихах без перелома).
7. Если поле уже заполнено корректным значением — не включай его в changes.
